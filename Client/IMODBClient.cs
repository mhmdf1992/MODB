...
namespace MODB.Client{
    public interface IMODBClient{
        ...
        Task<PagedList<string>> GetValuesAsync(string db, IEnumerable<string> tags = null, long? from = null, long? to = null, int page = 1, int pageSize = 10, CancellationToken cs = default);
    }
}